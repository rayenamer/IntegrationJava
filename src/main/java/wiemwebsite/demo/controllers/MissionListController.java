...
public class MissionListController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        URL cssURL = getClass().getResource("/wiemwebsite/demo/style/missionform.css");
        if (cssURL == null) {
    ...
    private void handleAddMission() {
        try {
            URL fxmlUrl = getClass().getResource("/wiemwebsite/demo/FXML/Missionfreelencer.fxml");
            if (fxmlUrl == null) {
    ...
    private void handleApply(Missionfreelencer mission) {
        ...
        try {
            URL fxmlUrl = getClass().getResource("/wiemwebsite/demo/FXML/postulemission.fxml");
            if (fxmlUrl == null) {
    ...
    private void handleConsulterCandidatures(Missionfreelencer mission) {
        ...
        try {
            URL fxmlUrl = getClass().getResource("/wiemwebsite/demo/FXML/demande_mission.fxml");
            if (fxmlUrl == null) {
