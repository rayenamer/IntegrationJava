...
public class AccueilController {
    ...
    public void initialize() {
        ...
        // Afficher le bouton Admin Panel si l'utilisateur connecté est modérateur
        if (Session.getCurrentUser() != null && Session.getCurrentUser().getRoles().equals("moderateur")) {
